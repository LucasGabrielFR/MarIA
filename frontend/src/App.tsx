    ...
    <div className="flex bg-slate-50 min-h-screen font-sans antialiased overflow-hidden">
      ...
      <main className="flex-1 p-8 overflow-y-auto">
        <header className="mb-10 flex justify-between items-center">
          <div>
            <h2 className="text-3xl font-bold text-slate-800 tracking-tight">Dashboard Geral</h2>
            <p className="text-slate-500 mt-1">Bem-vindo ao painel de controle da MarIA.</p>
          </div>
          <div className="flex items-center gap-4">
             <div className="text-right hidden sm:block">
                <p className="text-sm font-bold text-slate-800">Lucas Gabriel</p>
                <p className="text-xs text-slate-500">Administrador</p>
             </div>
             <Avatar className="h-10 w-10 border-2 border-primary/20">
                <AvatarFallback className="bg-primary text-white">LG</AvatarFallback>
             </Avatar>
          </div>
        </header>
