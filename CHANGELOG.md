...
### Changed
- **Redesign Premium do Botão do WhatsApp:** O botão flutuante foi reestilizado para se adequar ao branding premium da MarIA (utilizando um gradiente Royal Blue `from-[#0047AB] to-[#0056D2]` com borda dourada elegante `border-[#D4AF37]/45` e tooltip no tema escuro clássico do site), substituindo a cor verde genérica original por uma estética que harmoniza perfeitamente com a Landing Page.
