...
- **Botão do WhatsApp Flutuante:** Adicionado um botão flutuante de WhatsApp premium no canto inferior direito da Landing Page. Ele conta com efeitos dinâmicos de ripple, micro-interações de escala e rotação no hover, e um elegante tooltip deslizante ("Fale com a MarIA") que guia o usuário a iniciar uma conversa com o número do bot `(62) 98194-9980`.
